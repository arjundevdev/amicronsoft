...
function tt_testimonial_module_cpt() {
	...
	if( function_exists( 'tt_temptt_get_option' ) ) {
		...
		$testimonial_cpt_single = tt_temptt_get_option( 'testimonial_cpt_single', true );
	}
	// With Front
	...
	$cpt_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Testimonial', 'allureshop' ),
			'singular_name' => esc_attr__( 'Testimonial', 'allureshop' ),
			'add_new' => esc_attr__( 'Add Testimonial', 'allureshop' ),
			'add_new_item' => esc_attr__( 'Add Testimonial', 'allureshop' ),
			'edit' => esc_attr__( 'Edit', 'allureshop' ),
			'edit_item' => esc_attr__( 'Edit Testimonial', 'allureshop' ),
			'new_item' => esc_attr__( 'New Testimonial', 'allureshop' ),
			'view' => esc_attr__( 'View Testimonial', 'allureshop' ),
			'view_item' => esc_attr__( 'View Testimonial', 'allureshop' ),
			'search_items' => esc_attr__( 'Search Testimonial', 'allureshop' ),
			'not_found' => esc_attr__( 'No Testimonial found', 'allureshop' ),
			'not_found_in_trash' => esc_attr__( 'No Testimonial found in Trash', 'allureshop' ),
			'parent' => esc_attr__( 'Parent Testimonial', 'allureshop' ),
		),
		'public' => true,
	...
	$tax_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Testimonial Categories', 'allureshop' ),
