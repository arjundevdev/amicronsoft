...
function tt_portfolio_module_cpt() {
	...
	$cpt_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Portfolio', 'allureshop' ),
			'singular_name' => esc_attr__( 'Portfolio', 'allureshop' ),
			'add_new' => esc_attr__( 'Add Portfolio', 'allureshop' ),
			'add_new_item' => esc_attr__( 'Add Portfolio', 'allureshop' ),
			'edit' => esc_attr__( 'Edit', 'allureshop' ),
			'edit_item' => esc_attr__( 'Edit Portfolio', 'allureshop' ),
			'new_item' => esc_attr__( 'New Portfolio', 'allureshop' ),
			'view' => esc_attr__( 'View Portfolio', 'allureshop' ),
			'view_item' => esc_attr__( 'View Portfolio', 'allureshop' ),
			'search_items' => esc_attr__( 'Search Portfolio', 'allureshop' ),
			'not_found' => esc_attr__( 'No Portfolio found', 'allureshop' ),
			'not_found_in_trash' => esc_attr__( 'No Portfolio found in Trash', 'allureshop' ),
			'parent' => esc_attr__( 'Parent Portfolio', 'allureshop' ),
		),
		'public' => true,
	...
	$tax_args = array(
		'labels' => array(
			'name' => esc_attr__( 'Portfolio Categories', 'allureshop' ),
