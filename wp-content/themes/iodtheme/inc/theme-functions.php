...
if ( ! function_exists( 'iodtheme_tt_prev_post' ) ) {
	function iodtheme_tt_prev_post() {
		...
		if ( is_a( $prev_post, 'WP_Post' ) ) {
			$output = '<div class="fl button3"><a class="tt_prev_post tt-button" title="'. get_the_title( $prev_post->ID ) .'" href="' . get_permalink( $prev_post->ID ) . '"><i class="fa fa-long-arrow-left"></i>' . esc_html__( 'Previous Post', 'iodtheme' ) . '</a></div>';
		}
...
if ( ! function_exists( 'iodtheme_tt_next_post' ) ) {
	function iodtheme_tt_next_post() {
		...
		if ( is_a( $prev_post, 'WP_Post' ) ) {
			$output = '<div class="fr button3"><a class="tt_next_post tt-button" title="'. get_the_title( $prev_post->ID ) .'" href="' . get_permalink( $prev_post->ID ) . '">' . esc_html__( 'Next Post', 'iodtheme' ) . '<i class="fa fa-long-arrow-right"></i></a></div>';
		}
